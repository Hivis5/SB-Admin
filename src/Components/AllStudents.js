...
function AllStudents() {
    ...
    let getData = async ()=>{
        let d  = await axios.get('https://61585ceb5167ba00174bbab4.mockapi.io/users/')
        console.log(d)
        setData(d.data)
    }
    ...
    let handleDelete = async(id)=>{
        try{
            let res = await axios.delete('https://61585ceb5167ba00174bbab4.mockapi.io/users/'+id)
            console.log(res);
            getData();
        }
        catch(err){
